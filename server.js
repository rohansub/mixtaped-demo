...
try {
	var privateKey = fs.readFileSync('/etc/letsencrypt/keys/0000_key-certbot.pem').toString(),
		certificate = fs.readFileSync('/etc/letsencrypt/csr/0000_csr-certbot.pem').toString();
